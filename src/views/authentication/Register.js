            ...
            <div className="auth-box on-sidebar">
                <div id="loginform">
                    <div className="logo">
                        ...
                        <h5 className="font-medium mb-3">Sign Up to Osmosis</h5>
                    </div>
                    <Row>
                        <Col xs="12">
                            <Form className="mt-3" id="loginform" action="/dashbaord">
                                <FormGroup className="mb-3">
                                    <Input type="text" name="customercode" id="customercode" placeholder="Customer Code" bsSize="lg" required />
                                </FormGroup>
                                <FormGroup className="mb-3">
                                    <Input type="text" name="invitationcode" id="invitationcode" placeholder="Invitation Code" bsSize="lg" required />
                                </FormGroup>
                                <FormGroup className="mb-3">
                                    <Input type="text" name="username" id="username" placeholder="Username" bsSize="lg" required />
                                </FormGroup>
                                <FormGroup className="mb-3">
